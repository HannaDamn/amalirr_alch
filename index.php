<?php
	...
	for($i = 0; $i < count($ingrList); $i++) {
			$template .= '<div class="ingr_items"><img class="ingrCard" src="/mods/holydays/alchimia/img/imgCard.png"><div class="r_buttons"><div id="'.$i.'-base-but" onclick="showMe('.$i.', \'base\')"><div id="'.$i.'-base-but-bg" class="r_button"></div><span class="r_button_text">Сырой</span></div>';
			...
			$template .= '<div id="'.$i.'-type3-but" onclick="showMe('.$i.', \'type3\')"><div id="'.$i.'-type3-but-bg" class="r_button"></div><span class="r_button_text">Вытяжка</span></div></div>';
