<?php
	...
	for($i = 0; $i < count($ingrList); $i++) {
		$template .= '<div class="ingr_items"><div class="r_buttons"><div id=id="'.$i.'-base-but" onclick="showMe('.$i.', \'base\')"><div id="'.$i.'-base-but-bg" class="r_button"></div><span class="r_button_text">Сырой</span></div>';
